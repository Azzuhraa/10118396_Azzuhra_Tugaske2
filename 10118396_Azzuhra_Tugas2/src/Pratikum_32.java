 ...
 * @author LENOVO
 */
public class Pratikum_32 extends javax.swing.JFrame {

    /**
     * Creates new form Pratikum_32
     */
    public Pratikum_32() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Arial", "Verdana", "Tohama" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        else if (jComboBox1.getSelectedItem()=="Tohama")
        {
            jTextArea1.setFont(new Font("Tohama",Font.PLAIN,12));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pratikum_32.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pratikum_32().setVisible(true);
            }
        });
    }
